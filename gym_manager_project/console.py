...
workout1 = Workout('YOGA', 'Slow, restorative Vinyasa flow. Caters to all abilities', 45, '2022-12-01', '19:30', 12, '1')
workout_repository.save(workout1)
workout2 = Workout('STRENGTH', 'Intermediate class with barbell based movements', 50, '2022-12-23', '18:00', 8, '1')
workout_repository.save(workout2)
workout3 = Workout('CARDIO', 'Interval style session on the Concept II rower', 45, '2022-12-25', '08:00', 8, '1')
workout_repository.save(workout3)
workout4 = Workout('PILATES', 'Full-body intermediate pilates workout', 35, '2022-12-26', '19:00', 12, '0')
workout_repository.save(workout4)
workout5 = Workout('MOBILITY', 'Early morning hip focussed mobility session', 60, '2022-12-27', '06:15', 12, '1')
workout_repository.save(workout5)
workout6 = Workout('WEIGHTLIFTING', 'Weekly barbell weightlifting club', 60, '2022-12-28', '08:00', 4, '1')
