...
workout1 = Workout('Yoga', 'Vinyasa style flow', 45, '2022-12-22', '1930', 20, '1')
workout_repository.save(workout1)
workout2 = Workout('Strength', 'Barbell based movements', 50, '2022-12-23', '0700', 12, '1')
workout_repository.save(workout2)
workout3 = Workout('Cardio', 'Rowing based intervals', 40, '2022-12-24', '0800', 12, '0')
