...
workout1 = Workout('Yoga', 'Vinyasa style flow', 45, '2022-12-22', '19:30:00', 20, '1')
workout_repository.save(workout1)
workout2 = Workout('Strength', 'Barbell based movements', 50, '2022-12-23', '07:00:00', 12, '1')
workout_repository.save(workout2)
workout3 = Workout('Cardio', 'Rowing based intervals', 40, '2022-12-24', '08:00:00', 12, '0')
